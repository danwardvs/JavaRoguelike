...
public class Label {
	...
	public Label(MouseHandler newMouseHandler, Menu newParentMenu, int newX, int newY, int newWidth, int newHeight, float newR, float newG, float newB,float newFontSize, String newText, boolean newActive, boolean newVisible){
		x = newX;
		y = newY;
		width = newWidth;
		height = newHeight;
